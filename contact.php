        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-12">
                <div class="contact-info">
                    <h3>Here to Help</h3>
                    <p>Have a question? You may find an answer in our <a href="#">FAQs</a>. But you can also contact
                        us.</p>
                    <ul class="contact-list">
                        <li><i class="bx bx-map"></i> Location: <a href="#">Wonder Street, USA, New York</a></li>
                        <li><i class="bx bx-phone-call"></i> Call Us: <a href="tel:+01321654214">+01 321 654 214</a>
                        </li>
                        <li><i class="bx bx-envelope"></i> Email Us: <a
                                href="/cdn-cgi/l/email-protection#3d55585151527d45495253135e5250"><span
                                    class="__cf_email__"
                                    data-cfemail="78101d14141738000c1716561b1715">[email&#160;protected]</span></a>
                        </li>
